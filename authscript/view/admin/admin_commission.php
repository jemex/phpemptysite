<div class="search_customers">
    <div class="my_ser_form">
        <div class="my_se_heading ripple-effect">
            <h2>Withdrawal Request<i class="fa fa-angle-double-right" aria-hidden="true"></i></h2>
        </div>
        <div class="customers_tables">
            ...
            <?php
            if ($table_data[0]['result'] == 0 && $table_data[0]['msg'] != '') {
                        ...
                        <tbody>
                            ...
                            foreach ($table_data as $history) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ucfirst($history['display_name']); ?></td>
