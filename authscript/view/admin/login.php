                ...
                <div class="dlogin-from">
                    ...
                    <div class="dlogin-cfrom">
                        <div class="row">
                            ...
                            ?>
                            <form action="<?php echo $GLOBALS['ep_dynamic_url']; ?>adminmain" method="post" class="col-sm-12 adminloginform">
                                <div class="col-sm-12 ro-input-form">
                                    <div class="form-group">
                                        <input id="email2" name="username" type="text" class="ro-input-text ro-color-picton_blue ro-font form-control in_typing" value="<?php if (isset($_POST['username'])) {
                                echo $post['username'];
                            } ?>" autocomplete="off">
                                        <label for="email2">
                                            <p class="ro-font">Username</p>
                                        </label>
                                    </div>
                                ...
                                <div class="col-sm-12 ro-input-form">
                                    <div class="form-group">
                                        <input  id="pass" class="ro-input-text ro-color-picton_blue ro-font form-control in_typing" name="password" type="password" value="" autocomplete="off">
                                        <label for="pass">
...
<!--                                <div class="col-sm-12 ro-input-form">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo $GLOBALS['ep_dynamic_url']; ?>adminmain/forgot_password">Forgot Password</a>
                                    </div>
                                </div>-->
                                <div class="col-sm-12 ro-input-form">
                                    <div class="form-group">
