                           ...
                           <?php 
                            ...
                            foreach($table_data as $history){ ?>
                              <tr>
                                 ...
                                 <td><?php echo ucfirst($history['username']); ?></td>
                                 <td><?php echo ucfirst(str_replace("_"," ",$history['transaction_type'])); ?></td>
                                 <td><?php echo ($history['transaction_type'] == 'bet_win' ? ($history['bet_amount']*2) : $history['bet_amount']); ?></td>
<!--                                 <td><?php echo $history['amount']; ?></td>-->
<!--                                 <td><?php //echo $history['wallet_balance']; ?></td>-->
                              </tr>
                              <?php $count++; } ?>
